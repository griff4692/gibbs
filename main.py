...
def calculate_log_joint(args, X, z, components):
    log_joint = 0.0
...
if __name__ == '__main__':
    ...
    for iter in range(MAX_ITERS):
        ...
        log_joint = calculate_log_joint(args, X, z, components)
        ...
        args.use_validation and run_validation_tests(args, dev_X, dev_y)
